...
namespace PVRL
{
    public partial class InventoryControl : UserControl
    {
        ...
        public event EventHandler CloseInventoryRequested;

        public InventoryControl(List<Character> characters, Vault vault)
        {
            InitializeComponent();
            DoubleBuffered = true;
        ...
        {
            CloseInventoryRequested?.Invoke(this, EventArgs.Empty);
        }
